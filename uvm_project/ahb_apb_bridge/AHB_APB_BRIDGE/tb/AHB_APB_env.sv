...
class AHB_APB_env extends uvm_env;
  ...
  function void build_phase(uvm_phase phase);
    ...
    if (cfg.has_AHB_agent_top == 1) Hagnth = AHB_agent_top::type_id::create("Hagnth", this);

    if (cfg.has_APB_agent_top == 1) Pagnth = APB_agent_top::type_id::create("Pagnth", this);

    if (cfg.has_virtual_sequencer == 1) vseqrh = virtual_sequencer::type_id::create("vseqrh", this);

    if (cfg.has_scoreboard == 1) sb = scoreboard::type_id::create("sb", this);
  ...
  function void connect_phase(uvm_phase phase);
    ...
    if (cfg.has_APB_agent_top) vseqrh.Pseqrh = Pagnth.agnth.seqrh;

    if (cfg.has_AHB_agent_top) vseqrh.Hseqrh = Hagnth.agnth.seqrh;

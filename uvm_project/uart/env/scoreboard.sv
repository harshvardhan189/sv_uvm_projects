...
class scoreboard extends uvm_scoreboard;
  ...
  covergroup coverage;
    ...
    HADDR: coverpoint Hxtn.Haddr[31:0] {
      bins ADDR = {[32'h8000_0000 : 32'h8000_03ff],
    ...
    HSIZE: coverpoint Hxtn.Hsize[2:0] {
      bins S1 = {0, 1, 2}; ignore_bins illegal_S = {3, 4, 5, 6, 7};
    }

    PSELX: coverpoint Pxtn.Pselx[3:0] {
      bins P1 = {1, 2, 4, 8}; ignore_bins illegal = {0, 3, 5, 6, 7, 9, 10, 11, 12, 13, 14, 15};
    }

    PADDR: coverpoint Pxtn.Paddr[31:0] {
  ...
  task sb_compare();
    ...
    /////////////////// WRITING //////////////////////
    if (Hxtn.Hwrite) begin
      `uvm_info("SCOREBOARD", "---------- WRITING -----------", UVM_LOW)

      if (Hxtn.Haddr == Pxtn.Paddr) begin
        ...
        if (Hxtn.Hsize == 0) begin
          ...
          case (Hxtn.Haddr[1:0])
            2'b00:
            if (Hxtn.Hwdata[7:0] == Pxtn.Pwdata[7:0])
              `uvm_info("SCOREBOARD", "WRITE DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "WRITE DATA DID'T MATCH")
            2'b01:
            if (Hxtn.Hwdata[15:8] == Pxtn.Pwdata[7:0])
              `uvm_info("SCOREBOARD", "WRITE DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "WRITE DATA DID'T MATCH")
            2'b10:
            if (Hxtn.Hwdata[23:16] == Pxtn.Pwdata[7:0])
              `uvm_info("SCOREBOARD", "WRITE DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "WRITE DATA DID'T MATCH")
            2'b11:
            if (Hxtn.Hwdata[31:24] == Pxtn.Pwdata[7:0])
              `uvm_info("SCOREBOARD", "WRITE DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "WRITE DATA DID'T MATCH")
          endcase
        end else if (Hxtn.Hsize == 1) begin
          `uvm_info("SCOREBOARD", "Hsize is 1 ", UVM_LOW)
          case (Hxtn.Haddr[1:0])
            2'b00:
            if (Hxtn.Hwdata[15:0] == Pxtn.Pwdata[15:0])
              `uvm_info("SCOREBOARD", "WRITE DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "WRITE DATA DID'T MATCH")
            2'b10:
            if (Hxtn.Hwdata[31:16] == Pxtn.Pwdata[15:0])
              `uvm_info("SCOREBOARD", "WRITE DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "WRITE DATA DID'T MATCH")
          endcase
        end else if (Hxtn.Hsize == 2) begin
          `uvm_info("SCOREBOARD", "Hsize is 2 ", UVM_LOW)
          case (Hxtn.Haddr[1:0])
            2'b00:
            if (Hxtn.Hwdata[31:0] == Pxtn.Pwdata[31:0])
              `uvm_info("SCOREBOARD", "WRITE DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "WRITE DATA DID'T MATCH")
          endcase
        end else `uvm_error("SCOREBOARD", "HSIZE IS OUT OF BOUND VALUE")
      end
    end  ////////////////////// READING /////////////////////////////
      ...
      if (Hxtn.Haddr == Pxtn.Paddr) begin
        ...
        if (Hxtn.Hsize == 0) begin
          ...
          case (Hxtn.Haddr[1:0])
            2'b00:
            if (Hxtn.Hrdata[7:0] == Pxtn.Prdata[7:0])
              `uvm_info("SCOREBOARD", "READ DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "READ DATA DID'T MATCH")
            2'b01:
            if (Hxtn.Hrdata[7:0] == Pxtn.Prdata[15:8])
              `uvm_info("SCOREBOARD", "READ DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "READ DATA DID'T MATCH")
            2'b10:
            if (Hxtn.Hrdata[7:0] == Pxtn.Prdata[23:16])
              `uvm_info("SCOREBOARD", "READ DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "READ DATA DID'T MATCH")
            2'b11:
            if (Hxtn.Hrdata[7:0] == Pxtn.Prdata[31:24])
              `uvm_info("SCOREBOARD", "READ DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "READ DATA DID'T MATCH")
          endcase
        end else if (Hxtn.Hsize == 1) begin
          ...
          case (Hxtn.Haddr[1:0])
            2'b00:
            if (Hxtn.Hrdata[15:0] == Pxtn.Prdata[15:0])
              `uvm_info("SCOREBOARD", "READ DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "READ DATA DID'T MATCH")
            2'b10:
            if (Hxtn.Hrdata[15:0] == Pxtn.Prdata[31:16])
              `uvm_info("SCOREBOARD", "READ DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "READ DATA DID'T MATCH")
          endcase
        end else if (Hxtn.Hsize == 2) begin
          ...
          case (Hxtn.Haddr[1:0])
            2'b00:
            if (Hxtn.Hrdata[31:0] == Pxtn.Prdata[31:0])
              `uvm_info("SCOREBOARD", "READ DATA compared successfully", UVM_LOW)
            else `uvm_error("SCOREBOARD", "READ DATA DID'T MATCH")
          endcase
        end else `uvm_error("SCOREBOARD", "HSIZE IS OUT OF BOUND VALUE")
